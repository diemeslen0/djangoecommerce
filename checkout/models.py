...
class CartItem(models.Model):
    ...
    # cart_key = models.CharField('Chave do Carrinho', max_length=40, db_index=True) #original
    ...
    class Meta:
        ...
        unique_together = (('cart_key', 'product'),)  # evita que tenha o produto duplicado no carrinho
...
# utilização de signals do django que é disparada toda vez que um
# modelo CartItem é salvo, esse método é executado, como uma trigger
